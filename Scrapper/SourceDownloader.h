...
/*
	This class returns nicely formatted XML using only internet adress of the website. Extracting data is left for other parts of program in order to preserve single responsibility.
